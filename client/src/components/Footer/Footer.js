    ...
    <div className='container'>
        <div class="row d-flex justify-content-around text-light py-3 pb-0">
          <div class="col-md-4 col-sm-12 mt-4 text-center">
            ...
            <h2 class="fw-bold">AgroConnect</h2>
            <p class="fw-light m-0">Your trusted marketplace for fresh, locally-sourced produce directly from farmers.</p>
          </div>
          ...
          <div class="col-md-2 col-sm-12 mt-4 text-center text-md-start">
            ...
            <ul>
              <Link to="/laptop" class="text-decoration-none text-light"><li class="list-group-item m-2">Fruits</li></Link>
              <Link to="/tablet" class="text-decoration-none text-light"><li class="list-group-item m-2">Vegetables</li></Link>
              <Link to="/mobile" class="text-decoration-none text-light"><li class="list-group-item m-2">Grains</li></Link>
            </ul>
          </div>
          <div class="col-md-4 col-sm-12 mt-4 text-center text-md-start">
            <p class="fs-5 m-0">Contact</p>
            <ul>
              <li class="list-group-item my-2">📌 84, AgroConnect, Laxmi Narayan Chowk, Opposite Narayana Residency, Ward No 3, Prasad Colony, Pune - 411028</li>
              <li class="list-group-item my-2">📱<a href="mob:8010564343" class="text-decoration-none">+91 9310201011</a></li>
              <li class="list-group-item my-2">✉️<a href="mailto:hemantagl206@gmail.com" class="text-decoration-none"> AgroConnect@gmail.com</a></li>
          ...
          <p class="text-center pt-4">Copyright © <a href="https://Srushti-Garad.vercel.app/" class="text-decoration-none text-light">AgroConnect</a> 2025</p>
        </div>
    </div>
    </div>
  )
