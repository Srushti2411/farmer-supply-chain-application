...
function Navbar() {
  return (
    ...
    <div className="container-fluid mx-5">
      <Link to="#" className="navbar-brand ms-md-5 ms-md-0 fs-3">AgroConnect🌿</Link>
        ...
        <ul className="navbar-nav ms-auto">
          ...
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu">
              <li><Link to="/mobile" className="dropdown-item">Fruits</Link></li>
              <li><Link to="/laptop" className="dropdown-item">Vegetables</Link></li>
              <li><Link to="/tablet" className="dropdown-item">Grains</Link></li>
            </ul>
          </li>
          <li className="nav-item">
