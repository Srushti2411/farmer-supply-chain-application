...
import Image from "./electronics.jpg"
          ...
          <div className='container'>
            <div className='d-flex justify-content-evenly flex-wrap'>
              ...
              <div className='card wh mt-4 mt-md-0 p-3 py-4 shadow rounded-4'>
                <img src={Fruits} className='mx-auto img-whh' />
                <h3 className='text-center'>Fruits</h3>
              </div>
              </Link>
              <Link className='text-decoration-none' to='/laptop'>
              <div className='card wh mt-4 mt-md-0 p-3 py-4 shadow rounded-4'>
                <img src={Vegetables} className='mx-auto img-whh mt-4' />
                <h3 className='text-center mt-5'>Vegetables</h3>
              </div>
              </Link>
              <Link className='text-decoration-none' to='/tablet'>
              <div className='card wh mt-4 mt-md-0 p-3 py-4 shadow rounded-4'>
                <img src={Grains} className='mx-auto img-whh mt-4 mb-1' />
                <h3 className='text-center mt-5'>Grains</h3>
              </div>
              </Link>
